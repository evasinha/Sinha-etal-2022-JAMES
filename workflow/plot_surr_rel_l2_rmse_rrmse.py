...
#----------------------------------------------------------
def plot_timeseries(ds_plot, title, varname, ylabel, metric):
    ...
    plt.savefig('../figures/' + title + '_' +  varname + '_' + metric + '.png', bbox_inches='tight') 

#----------------------------------------------------------
def plot_timeseries_subplots(ds_plot, title, ylabel, metric):
    """Plot timeseries from input xarray
    :param: ds_plot        2d numpy array to plot
    :param: title:         variable title for plotting
    :param: ylabel:        variable ylabel for plotting
    ...
    ax[0].text(0.02, 0.93, title, color='black', transform=ax[0].transAxes, fontsize=18, bbox=dict(facecolor='white', edgecolor='white'))
    ...
    plt.savefig('../figures/' + title + '_' + metric + '.png', bbox_inches='tight')
...
plot_timeseries_subplots(rel_l2_val, title, ylabel='Relative surrogate error', metric='rel_l2')
plot_timeseries_subplots(rmse_val,   title, ylabel='RMSE',                     metric='rmse')
plot_timeseries_subplots(rrmse_val,  title, ylabel='Relative RMSE',            metric='rrmse')

plot_timeseries(rel_l2_val[0:365, :],     title, varname='GPP', ylabel='Relative surrogate error', metric='rel_l2')
plot_timeseries(rel_l2_val[365:730, :],   title, varname='ER',  ylabel='Relative surrogate error', metric='rel_l2')
plot_timeseries(rel_l2_val[730:1095, :],  title, varname='LE',  ylabel='Relative surrogate error', metric='rel_l2')
plot_timeseries(rel_l2_val[1095:1460, :], title, varname='H',   ylabel='Relative surrogate error', metric='rel_l2')

plot_timeseries(rmse_val[0:365, :],       title, varname='GPP', ylabel='RMSE [$\mathregular{gC~m^{-2}~day^{-1}}$]', metric='rmse')
plot_timeseries(rmse_val[365:730, :],     title, varname='ER',  ylabel='RMSE [$\mathregular{gC~m^{-2}~day^{-1}}$]', metric='rmse')
plot_timeseries(rmse_val[730:1095, :],    title, varname='LE',  ylabel='RMSE [$\mathregular{W~m^{-2}}$]', metric='rmse')
plot_timeseries(rmse_val[1095:1460, :],   title, varname='H',   ylabel='RMSE [$\mathregular{W~m^{-2}}$]', metric='rmse')

plot_timeseries(rrmse_val[0:365, :],       title, varname='GPP', ylabel='Relative RMSE', metric='rrmse')
plot_timeseries(rrmse_val[365:730, :],     title, varname='ER',  ylabel='Relative RMSE', metric='rrmse')
plot_timeseries(rrmse_val[730:1095, :],    title, varname='LE',  ylabel='Relative RMSE', metric='rrmse')
plot_timeseries(rrmse_val[1095:1460, :],   title, varname='H',   ylabel='Relative RMSE', metric='rrmse')
